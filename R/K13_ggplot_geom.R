...
# one by one. Run this code to get started:
...
# Previously we've learned: to visualize the distribution of a single continuous
# variable, you can use 'geom_histogram'. Or you can also use these:
...
# 15. Instead of plotting 'gdpPercap' on the x-axis, plot the log of 'gdpPercap'
# using log(). You should find that a linear model seems to fit this
